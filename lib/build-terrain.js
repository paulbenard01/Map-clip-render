...
async function main() {
  ...
  // Still downscaled — not for a GPU limit anymore, but because the
  // renderer decodes this into a plain in-memory pixel array for per-pixel
  // sampling, and the source TIFF's full 21600px width would mean holding
  // a ~900MB decoded buffer for that.
  const MAX_DIM = 4096;

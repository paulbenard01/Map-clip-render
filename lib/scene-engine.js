...
(function (root, factory) {
  ...
  function normalizeScene(scene) {
    ...
    out.titles = (s.titles || []).map(function (t, i) {
      ...
      return {
        ...
        // Bold by default; all-caps is opt-in, not the default -- it reads
        // as shouting on most short captions.
        caps: t.caps === true,
        bold: t.bold !== false,
        color: t.color || null,
      };
  ...
  function serializeScene(scene) {
    ...
    out.pins = s.pins.map(function (p, i) {
      ...
      if (p.labelCaps) o.labelCaps = true;
    ...
    out.routes = s.routes.map(function (r, i) {
      ...
      if (r.labelCaps) o.labelCaps = true;
